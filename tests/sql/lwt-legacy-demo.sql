-- Legacy LWT (Hungarian-prefix) demo database — the pre-modernization db/seeds/demo.sql.
-- Kept as a fixture for exercising the legacy->modern restore/upgrade path.
