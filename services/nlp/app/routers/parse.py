...
from app.services.parsers import mecab, jieba, kiwi
...
async def parse(request: ParseRequest):
    ...
    elif request.parser == 'kiwi':
        return kiwi.parse(request.text)
    else:
...
async def available_parsers():
    ...
    return {
        "parsers": [
            ...
            {"id": "kiwi", "name": "Kiwi (Korean)", "languages": ["ko"]},
        ]
    }
