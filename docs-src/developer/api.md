# Lukaisu Server REST API Documentation

This documentation provides an overview of the REST API endpoints available for Lukaisu Server-community.
The Lukaisu Server API allows developers to interact with various features of the application,
...
Currently, the Lukaisu Server API does not require authentication. However, authentication
...
Retrieves the version of the Lukaisu Server API.
